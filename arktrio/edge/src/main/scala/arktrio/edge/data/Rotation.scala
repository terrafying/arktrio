...
import arktrio.common.data.QuaternionEnu
import arktrio.common.data.QuaternionEnuExtensions.*
...
import arktrio.edge.configs.{AxisConfig, EulerAnglesConfig, QuaternionConfig, RotationConfig}
import arktrio.edge.util.JsonDerivation
import sttp.tapir.*
