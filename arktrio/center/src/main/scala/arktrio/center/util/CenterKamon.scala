...
package arktrio.center.util

import arktrio.common.util.MachineDurationHistogram
import kamon.Kamon
...
object CenterKamon:
  ...
  val chartPublishAgentNumName: String = "arktrio_center_chart_2_publish_agent_num"
  val chartPublishBatchNumName: String = "arktrio_center_chart_2_publish_batch_num"
  val chartPublishMachineLatencyName: String =
    "arktrio_center_chart_2_publish_from_edge_machine_latency"
  val chartRouteAgentNumName: String = "arktrio_center_chart_3_route_agent_num"
  val chartRouteBatchNumName: String = "arktrio_center_chart_3_route_batch_num"
  val chartRouteMachineLatencyName: String =
    "arktrio_center_chart_3_route_machine_from_publish_machine_latency"
  val chartSubscribeAgentNumName: String = "arktrio_center_chart_4_subscribe_agent_num"
  val chartSubscribeBatchNumName: String = "arktrio_center_chart_4_subscribe_batch_num"
  val chartSubscribeMachineLatencyName: String =
    "arktrio_center_chart_4_subscribe_from_route_machine_latency"
  val deadLetterNumName: String = "arktrio_center_dead_letter_num"
