...
import arktrio.common.data.{TaggedTimestamp, Vector3Enu}
import arktrio.common.util.LoggerConfigurator.LogLevel
import arktrio.common.util.PureConfigHints.given
...
object CenterConfig:
  private val configSource = ConfigSource.defaultOverrides
    ...
    ) // merged reference.conf from Pekko, Kamon and Arktrio
